...
config_file = '/home/zhangrx/objectdetection/mmlab_RS/mmdetection/myshipcasR50/cascade_rcnn_r50_fpn_1x_coco.py'
checkpoint_file = '/home/zhangrx/objectdetection/mmlab_RS/mmdetection/work_dirs/cascade_rcnn_r50_mixval_all_new/epoch_9.pth'
...
# /home/zhangrx/objectdetection/mmlab_RS/mmdetection/work_dirs/cascade_rcnn_x101_selfvalwithtrain/
...
resxml_path = "/data/zrx/SAR_ship/data/val-resxml-mixvalall-new/"
'''

val_path = "/data/zrx/SAR_ship/data/newimage/"
res_path = "/data/zrx/SAR_ship/data/val-res-faster/"
resxml_path = "/data/zrx/SAR_ship/data/train-resxml-cascadeR50-epoch9/"
'''
try:
    os.mkdir(res_path)
except:
...
for i, img_name in enumerate(imgs):
    filename = img_name.split('.jpg')[0]# .jpg for val
